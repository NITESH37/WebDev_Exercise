...
export default function Header() {
  ...
  return (
    <header className="shadow sticky z-50 top-0">
      <nav
        className="bg-gray-600 border-gray-200 px-4 lg:px-6 py-2.5
            "
      >
        <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl sm:items-center">
          ...
          <div
            className={` ${
              isopen ? "flex" : "hidden"
            } lg:justify-between justify-center  md:justify-center items-center w-full lg:flex lg:w-auto lg:order-1`}
          >
